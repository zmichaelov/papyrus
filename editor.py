...
#        delete.SetBitmap(wx.Bitmap('icons/stock_delete-16.png',))
        ...
        #help = wx.Menu()
        about = wx.MenuItem(file, 112, '&About\tF1', 'About Editor')
#        about.SetBitmap(wx.Bitmap('icons/stock_about-16.png'))
        ...
        self.toolbar.AddSimpleTool(801, wx.Bitmap('Milky/Icons/48/8.png'), 'New', '')
        self.toolbar.AddSimpleTool(802, wx.Bitmap('Milky/Icons/48/119.png'), 'Open', '')
        self.toolbar.AddSimpleTool(803, wx.Bitmap('Milky/Icons/48/7.png'), 'Save', '')
        self.toolbar.AddSeparator()

        self.toolbar.AddSimpleTool(804, wx.Bitmap('Milky/Icons/48/89.png'), 'Cut', '')
        self.toolbar.AddSimpleTool(805, wx.Bitmap('Milky/Icons/48/34.png'), 'Copy', '')
        self.toolbar.AddSimpleTool(806, wx.Bitmap('Milky/Icons/48/43.png'), 'Paste', '')
        self.toolbar.AddSeparator()

        #self.toolbar.AddSimpleTool(807, wx.Bitmap('Milky/Icons/48/120.png'), 'Exit', '')
    ...
    def OnOpenFile(self, event):
        ...
        if self.modify:
            dlg = wx.MessageDialog(self, 'Save changes?', '', wx.YES_NO | wx.YES_DEFAULT | wx.CANCEL | wx.ICON_QUESTION)
            val = dlg.ShowModal()
            if val == wx.ID_YES:
